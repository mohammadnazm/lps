...
?>
<?php
if (!isset($_SESSION['loginass']) || $_SESSION['loginass'] !== true) {
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-dark border-bottom border-body" data-bs-theme="dark">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="manager.php"><?= htmlspecialchars(schoolName(currentSchoolScope())) ?></a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                            <a class="btn btn-info col-12"
                                href="attendance.php">تۆمارکردنی نەهاتوو </a>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-info col-12"
                                href="display_att.php">لیستی نەهاتوو </a>
                        </li>
                        <li class="nav-item ">
