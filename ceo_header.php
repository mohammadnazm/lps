...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark top-navbar sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="ceo_home.php">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page == 'ceo_home.php') ? 'active' : '' ?>" href="ceo_home.php">پێشەکی</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page == 'ceo_se.php') ? 'active' : '' ?>" href="ceo_se.php">گەران بەدوای قوتابی</a>
                    </li>
