...
function getDhySearch($table)
{
    ...
    if (!empty($_POST['st_name'])) {
        ...
        foreach ($words as $word) {
            if (!empty($word))
                $nameConditions[] = "TRIM(st_name) LIKE '%$word%' AND st_gender='" . $_SESSION['useraccess'] . "'";
        }
    ...
    if (!empty($_POST['st_group']))
        $conditions[] = "st_group='" . mysqli_real_escape_string($conn, $_POST['st_group']) . "' AND st_gender='" . $_SESSION['useraccess'] . "'";

    if (!empty($_POST['st_class']))
        $conditions[] = "st_class='" . mysqli_real_escape_string($conn, $_POST['st_class']) . "' AND st_gender='" . $_SESSION['useraccess'] . "'";
