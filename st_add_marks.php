    ...
    <div class="student-form-card">
        ...
        ">
                ...
                <select class="form-control card shadow-sm" name="grade" required style="width:140px;">
                    <option value="10" <?php if ($selected_grade == "10") echo "selected"; ?>>10</option>
                    <option value="11" <?php if ($selected_grade == "11") echo "selected"; ?>>11</option>
                    <option value="12" <?php if ($selected_grade == "12") echo "selected"; ?>>12</option>
                </select>
