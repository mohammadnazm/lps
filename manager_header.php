...
<head>
    ...
    <title>Lozan Manager Panel</title>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page == 'manager_home.php') ? 'active' : '' ?>" href="manager_home.php">پێشەکی</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page == 'manager.php') ? 'active' : '' ?>" href="manager.php">گەران</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page == 'today_att.php') ? 'active' : '' ?>" href="today_att.php">تۆماری نەهاتوو</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= ($current_page == 'lozanstaaffpage.php') ? 'active' : '' ?>" href="lozanstaaffpage.php">ستافی مامۆستایان</a>
                    </li>
                    ...
                    <li class="nav-item d-flex align-items-center ms-lg-3 mt-2 mt-lg-0 gap-2">
                        ...
                        <a class="btn btn-danger btn-sm btn-logout" href="logout_session.php">چوونەدەرەوە</a>
                    </li>
                </ul>
            </div>
        </div>
