        ...
        <div style="display:flex;gap:10px;justify-content: space-between;padding:5px;margin:10px;align-items: flex-start;">
            ...
            <div>
                ...
                <div style="display: flex;flex-direction: column;gap:6px">
                    ...
                    <?php
                    if ($_SESSION['useraccess'] == "All" && $_SESSION['loginViewer'] = true) {
                        $vp = "hidden";
                    } else {
                        $vp = "";
                    }
                    ...
                    <h6 style="text-align: right;" <?php echo $vp; ?>>
                        کرێی خوێندن : <?php echo number_format((int)$stpay); ?>
                    </h6>                    <h6 style="text-align: right;"> دوا قوتابخانە : <?php echo "<t style='color:darkblue'>{$scnm}</t>" ?></h6>
