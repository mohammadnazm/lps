    ...
    <div class="student-form-card">
        <form action="" method="post">
            <div style="display: flex;gap:10px;flex-wrap: wrap;">
                <input class="form-control card shadow-sm" name="sbname" placeholder="Subject" type="text" required>
                <button class="btn btn-success col-12" name="u_add" type="submit">Add Subject</button>
            </div>
        </form>
    </div>
    <br>
            ...
            <tbody>
                ...
                if ($stdList->num_rows > 0) {
                    while ($row = $stdList->fetch_assoc()) {
                        ...
                        echo "<td>{$counter}</td>";
                        echo "<td style='text-align:center'>{$row['sb_name']}</td>";
                        echo "<td style='text-align:center'><a class='btn btn-danger btn-sm' role='button' href='st_marks.php?did=" . $row['id'] . "' onclick=\"return confirm('Are you sure you want to delete this?');\"'>Delete</a></td>";
                        echo "<tr style='text-align:center'>";
                        $counter++;
                        $totcou = $counter;
                    }
